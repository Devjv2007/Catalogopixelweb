...
export function Home() {
  return (
    <main className="relative min-h-screen bg-white text-slate-100">
      <Header />

      <section className="relative z-10 flex min-h-[70vh] flex-col items-center justify-center px-6 pt-32 text-center">
        <span className="inline-flex items-center gap-2 px-4 py-1 mb-4 text-xs font-medium border rounded-full border-black/10 bg-black/5 text-black/80 backdrop-blur">
          PixelWeb
        </span>

        <h1 className="max-w-3xl text-4xl font-extrabold leading-tight text-black md:text-6xl">
        ...
        <p className="max-w-2xl mt-6 text-base text-black/70 md:text-lg">
