const Footer = () => {
  return (
    <footer className="relative mt-32 overflow-hidden bg-slate-950">
      {/* Glow de fundo */}
        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3">
              <img src="pixelweb.png" alt="Pixelweb" className="h-10" />
            </div>

            <p className="max-w-md mt-4 text-sm text-white/70">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="#pages" className="text-white/70 hover:text-white">
                  Landing Pages
                </a>
              </li>
              <li>
                <a href="#ecommerces" className="text-white/70 hover:text-white">
                  E-commerces
                </a>
              </li>
              <li>
                <a href="#sistemas" className="text-white/70 hover:text-white">
                  Sistemas
                </a>
              </li>
            </ul>
